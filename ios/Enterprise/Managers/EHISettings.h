...
/** @c YES if the dashboard notification prompt has been shown to this user in auth flow.
 This was added in addition to didPromptDashboardNewFeature after Localytics push notifications was intergrated.
 So after that we should prompt user even in unauth flow.*/
@property (assign, nonatomic) BOOL didPromptDashboardNotificationsUnuath;
