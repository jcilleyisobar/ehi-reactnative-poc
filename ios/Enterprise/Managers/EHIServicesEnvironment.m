...
- (NSString *)apiKeyForEndpoint:(EHIEnvironmentType)endpoint
{
    switch(endpoint) {
        ...
        case EHIEnvironmentTypeEast:            return @"UDfpcLQxZnmHKGMiWYZnRnA/oyZtk/CvPSvY/i6RfNw=";
        case EHIEnvironmentTypeWest:            return @"UDfpcLQxZnmHKGMiWYZnRnA/oyZtk/CvPSvY/i6RfNw=";
        case EHIEnvironmentTypeBeta:            return @"UDfpcLQxZnmHKGMiWYZnRnA/oyZtk/CvPSvY/i6RfNw=";
        case EHIEnvironmentTypeProd:            return @"UDfpcLQxZnmHKGMiWYZnRnA/oyZtk/CvPSvY/i6RfNw=";
        case EHIEnvironmentTypeNumEnvironments: return nil;
    }
}
