...
#
# pragma mark - Data Collection Reminder
#

#define EHIAnalyticsDataCollectionReminderModalScreen     @"DataCollectionReminderModal"
#define EHIAnalyticsDataCollectionReminderModalState      @"DataCollectionReminder"
