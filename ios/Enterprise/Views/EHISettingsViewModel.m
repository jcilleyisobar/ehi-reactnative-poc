...
{
    [EHIAnalytics trackAction:EHIAnalyticsSettingsActionCleanHistoricalData handler:nil];
    ...
    EHISettingsAnalyticsModalViewModel *viewModel = [EHISettingsAnalyticsModalViewModel new];
    [viewModel present:^(NSInteger index, BOOL canceled) {
        // clear data
        if(index == 0) {
            ...
            NSString *message = EHILocalizedString(@"right_to_be_forgotten_success_toast", @"Mobile Analytics & App Usage historical data has been cleared", @"");
