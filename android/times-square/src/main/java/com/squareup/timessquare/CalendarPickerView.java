 ...
 * initialized after inflation with {@link #init(Date, Date, String)} and can be customized with any of the
...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    titleTextColor = a.getColor(R.styleable.CalendarPickerView_ts_titleTextColor,
    ...
    if (isInEditMode()) {
      ...
      init(new Date(), nextYear.getTime(), "CLOSED_DATES") //
   ...
   * @param closedDatesText
   */
  public FluentInitializer init(Date minDate,
                                Date maxDate,
                                String closedDatesText,
                                Locale locale) {
    ...
    while ((monthCounter.get(MONTH) <= maxMonth // Up to, including the month.
      ...
      MonthDescriptor month =
              new MonthDescriptor(monthCounter.get(MONTH),
   ...
   * @param closedDatesText
   */
  public FluentInitializer init(Date minDate, Date maxDate, String closedDatesText) {
    return init(minDate, maxDate, closedDatesText, Locale.getDefault());
  }
   ...
   * <p>
   * Important: set this before you call {@link #init(Date, Date, String)} methods.  If called afterwards,
