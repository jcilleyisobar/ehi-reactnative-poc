...
public class LocationMapBottomSheetBehavior <V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private LocationMapBottomSheetBehavior.BottomSheetCallback mCallback;
    ...
    /**
     * Default constructor for instantiating LocationMapBottomSheetBehaviors.
     */
    public LocationMapBottomSheetBehavior() {
    }

    /**
     * Default constructor for inflating LocationMapBottomSheetBehaviors from layout.
     *
     * @param context The {@link Context}.
     * @param attrs   The {@link AttributeSet}.
     */
    public LocationMapBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new LocationMapBottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), mState);
    }

    @Override
    public void onRestoreInstanceState(CoordinatorLayout parent, V child, Parcelable state) {
        LocationMapBottomSheetBehavior.SavedState ss = (LocationMapBottomSheetBehavior.SavedState) state;
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ...
            ViewCompat.postOnAnimation(child, new LocationMapBottomSheetBehavior.SettleRunnable(child, targetState));
        } else {
     ...
     */
    public void setBottomSheetCallback(LocationMapBottomSheetBehavior.BottomSheetCallback callback) {
        mCallback = callback;
    }
    ...
    void startSettlingAnimation(View child, int state) {
        ...
        if (state == STATE_COLLAPSED) {
            ...
            DLog.d("LOCATION_MAP_BOTTOM_SHEET_BEHAVIOR", "startSettingAnimation() - not able to set a state");
            return;
        }
        setStateInternal(STATE_SETTLING);
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ViewCompat.postOnAnimation(child, new LocationMapBottomSheetBehavior.SettleRunnable(child, state));
        }
    }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (mViewDragHelper.settleCapturedViewAt(releasedChild.getLeft(), top)) {
                ...
                ViewCompat.postOnAnimation(releasedChild,
                        new LocationMapBottomSheetBehavior.SettleRunnable(releasedChild, targetState));
            } else {
                setStateInternal(targetState);
            }
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public static final Creator<LocationMapBottomSheetBehavior.SavedState> CREATOR = ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks<LocationMapBottomSheetBehavior.SavedState>() {
                    @Override
                    public LocationMapBottomSheetBehavior.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                        return new LocationMapBottomSheetBehavior.SavedState(in, loader);
                    }

                    @Override
                    public LocationMapBottomSheetBehavior.SavedState[] newArray(int size) {
                        return new LocationMapBottomSheetBehavior.SavedState[size];
                    }
                });
    }

    /**
     * A utility function to get the {@link LocationMapBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link LocationMapBottomSheetBehavior}.
     * @return The {@link LocationMapBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> LocationMapBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof LocationMapBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with LocationBottomSheetBehavior");
        }
        return (LocationMapBottomSheetBehavior<V>) behavior;
    }
