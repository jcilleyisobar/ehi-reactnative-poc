...
public class PostExtrasModifyRequest extends AbstractRequestProvider<EHIReservation> {

	private String mReservationSessionId;
	private UpdateExtrasRequestParams mRequestParams;

	public PostExtrasModifyRequest(String reservationSessionId, List<EHIExtraItem> extras) {
