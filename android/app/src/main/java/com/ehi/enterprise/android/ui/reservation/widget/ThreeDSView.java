...
public class ThreeDSView extends WebView {
     ...
     */
    private String postbackUrl = "https://www.enterprise.com";
     ...
     */
    private ThreeDSViewAuthorizationListener authorizationListener = null;

    public ThreeDSView(final Context context) {
        super(context);
        initUI();
    }
...
//                }
    ...
    public ThreeDSView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        initUI();
    }

    public ThreeDSView(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        initUI();
    }

    public ThreeDSView(final Context context, final AttributeSet attrs, final int defStyle, final boolean privateBrowsing) {
        super(context, attrs, defStyle);
        initUI();
    }
     ...
     */
    public void setAuthorizationListener(final ThreeDSViewAuthorizationListener authorizationListener) {
    ...
    public void authorize(final String acsUrl, final String md, final String paReq, final String postbackUrl) {
        ...
        String postParams;
        try {
            postParams = String.format(Locale.US, "TermUrl=%1$s&PaReq=%2$s",
