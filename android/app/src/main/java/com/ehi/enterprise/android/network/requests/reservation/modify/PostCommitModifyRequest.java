...
import com.ehi.enterprise.android.network.request_params.reservation.modify.CommitModifyRequestParams;
import com.ehi.enterprise.android.network.requests.AbstractRequestProvider;
import com.ehi.enterprise.android.network.util.EHIUrlBuilder;

import java.util.Map;

public class PostCommitModifyRequest extends AbstractRequestProvider<EHIReservation> {

	private String mReservationSessionId;
	private CommitModifyRequestParams mRequestParams;

	public PostCommitModifyRequest(String reservationSessionId,
                                   String paymentId, String paRes) {
		mReservationSessionId = reservationSessionId;
		mRequestParams = new CommitModifyRequestParams(paymentId,paRes);
	}
