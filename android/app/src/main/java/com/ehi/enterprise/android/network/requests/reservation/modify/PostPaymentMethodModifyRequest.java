...
import com.ehi.enterprise.android.network.request_params.reservation.modify.PostPaymentMethodParams;
...
public class PostPaymentMethodModifyRequest extends AbstractRequestProvider<EHIReservation> {

	private String mReservationSessionId;
	private PostPaymentMethodParams mRequestParams;

	public PostPaymentMethodModifyRequest(String reservationSessionId,
	                                      List<String> paymentIds,
	                                      String billingAccount,
	                                      String billingAccountType) {
		mReservationSessionId = reservationSessionId;
		mRequestParams = new PostPaymentMethodParams(paymentIds, billingAccount, billingAccountType);
	}
