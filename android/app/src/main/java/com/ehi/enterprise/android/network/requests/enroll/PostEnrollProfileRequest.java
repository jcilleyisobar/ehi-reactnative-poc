...
public class PostEnrollProfileRequest extends AbstractRequestProvider<PostEnrollProfileResponse> {

    private final PostEnrollProfileParams mEhiEnrollProfile;

    public PostEnrollProfileRequest(EHIEnrollProfile ehiEnrollProfile) {
