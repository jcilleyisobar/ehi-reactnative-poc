...
/**
 * ISOBAR/EHI NOTE: this is almost full copy of DatePickerDialog from api 25.
 * We need this copy to fix samsung title problem, they override title with date so
 * there are no way to set title you need on Samsung S6.
 * */
 ...
 * guide.
 */
public class EHIDatePickerDialog extends AlertDialog implements OnClickListener,
     ...
     */
    public EHIDatePickerDialog(@NonNull Context context) {
     ...
     */
    public EHIDatePickerDialog(@NonNull Context context, @StyleRes int themeResId) {
     ...
     *                   on month)
     */
    public EHIDatePickerDialog(@NonNull Context context, @Nullable OnDateSetListener listener,
    ...
    private EHIDatePickerDialog(@NonNull Context context, @StyleRes int themeResId,
        ...
        final View view = inflater.inflate(R.layout.v_ehi_date_picker, null);
        setView(view);
