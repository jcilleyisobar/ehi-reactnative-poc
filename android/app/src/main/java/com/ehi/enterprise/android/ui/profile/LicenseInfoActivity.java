...
public class LicenseInfoActivity
        extends DataBindingViewModelActivity<ManagersAccessViewModel, ToolbarActivityBinding> {

    private static final String TAG = "LicenseInfoActivity";
    ...
    private void initViews() {
        ...
        getViewBinding().toolbarInclude.title.setText(R.string.profile_license_number_title);
    ...
    private void commitFragments() {
        new FragmentUtils.Transaction(getSupportFragmentManager(), FragmentUtils.ADD)
                .fragment(new LicenseInfoFragmentHelper.Builder().build())
