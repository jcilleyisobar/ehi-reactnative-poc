package com.ehi.enterprise.android.ui.widget.drawer;
...
public class FullScreenNavigationDrawer extends DrawerLayout {
	private static final int MIN_DRAWER_MARGIN = 0; // dp

	public FullScreenNavigationDrawer(Context context) {
		super(context);
	}

	public FullScreenNavigationDrawer(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public FullScreenNavigationDrawer(Context context, AttributeSet attrs, int defStyle) {
