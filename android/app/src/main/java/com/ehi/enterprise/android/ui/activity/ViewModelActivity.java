...
public abstract class ViewModelActivity<T extends ManagersAccessViewModel> extends ApiServiceActivity {
     ...
     * {@link #initDependencies()} is called from within the Activity's {@link #onResume()} lifecycle method for you
    ...
    protected void onApiServiceConnected() {
        ...
        getViewModel().setApiService(getApiService());
        getViewModel().onApiServiceConnected();
    }
