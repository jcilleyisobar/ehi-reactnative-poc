...
public class PostSelectUpgradeModifyRequest extends AbstractRequestProvider<EHIReservation> {


	private String mReservationSessionId;
	private String mCarClassCode;

	public PostSelectUpgradeModifyRequest(String reservationSessionId, String carClassCode) {
