...
public class PaymentOptionsActivity
    ...
    private void initViews() {
        ...
        getViewBinding().toolbarInclude.title.setText(R.string.profile_payment_info_header);
    ...
    private void commitFragments() {
        new FragmentUtils.Transaction(getSupportFragmentManager(), FragmentUtils.ADD)
                .fragment(new PaymentOptionsFragmentHelper.Builder().build())
