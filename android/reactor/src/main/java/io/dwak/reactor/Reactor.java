...
public final class Reactor {
    ...
    public ReactorComputation autoRun(ReactorComputationFunction function) {
        return autoRun(function, null);
    }

    public ReactorComputation autoRun(ReactorComputationFunction function, Exception e) {
        if (function == null) {
            throw new NullPointerException("function cannot be null!");
        }
        final ReactorComputation reactorComputation = new ReactorComputation(function, mCurrentReactorComputation, e);
        if (mActive) {
